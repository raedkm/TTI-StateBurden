...
#Part    : (08) Preparing original BoD estimates 
...
# Printing to excel -------------------------------------------------------
xlsx::write.xlsx(Table_1, "Output/Tables/Table_c1.xlsx", row.names = F)
xlsx::write.xlsx(POLLUT, "Output/Tables/Table_c2.xlsx", row.names = F)
...
for(i in 1:length(sheet)) {
  ...
  xlsx::write.xlsx(burden_c_list[i], "Output/Tables/burden_by_state_c.xlsx", sheetName = sheet[i], showNA=F, append = T, row.names = F)
