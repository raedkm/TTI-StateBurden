...
#Part    : (06) Creating Interactive Tables for the 500 Cities
...
htmlwidgets::saveWidget(widget = table_500, libdir = "Output/Interactive/Cities/", file = "Cities500.html")
