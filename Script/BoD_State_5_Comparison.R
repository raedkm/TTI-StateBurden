...
# Printing comparison tables ----------------------------------------------
 ...
 xlsx::write.xlsx(compare, "Results/Tables/Table_7.xlsx", row.names = F)
 xlsx::write.xlsx(compare_state, "Results/Tables/Table_8.xlsx", row.names = F) 
